    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-[#0a0a0f]/95 border-r border-[#1a1a2e] p-4 flex flex-col">
            ...
            <nav class="flex-1 space-y-1">
                ...
                <a href="my_requests.php" class="sidebar-item active">
        ...
        <main class="flex-1 p-6">
            <header class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-xl font-bold text-white glow-text">My Tickets</h1>
                    <p class="text-xs text-[#666] mt-0.5">View and manage your support requests</p>
                </div>
                <a href="submit_ticket.php" class="cyber-btn">
            ...
            <div class="cyber-card p-4 mb-6">
                <form method="GET" class="flex flex-wrap gap-4 items-end">
                    ...
                    <a href="my_requests.php" class="cyber-btn cyber-btn-secondary">Clear</a>
                </form>
            </div>
            ...
            <div class="cyber-card p-4">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-sm font-semibold text-white">Your Tickets (<?php echo $tickets ? $tickets->num_rows : 0; ?>)</h2>
                </div>
                                    ...
                                    <td colspan="7" class="text-center text-[#666] py-12">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <?php if ($search || $status_filter || $priority_filter): ?>
                                                <a href="my_requests.php" class="cyber-btn cyber-btn-secondary">Clear Filters</a>
                                            <?php else: ?>
                                                <a href="submit_ticket.php" class="cyber-btn">Submit First Ticket</a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                </tr>
