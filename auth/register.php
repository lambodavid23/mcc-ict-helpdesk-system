...
<body class="min-h-screen grid-bg flex items-center justify-center p-2">
    ...
    <div class="w-full max-w-[380px]">
        ...
        <div class="relative bg-[#0a0a0f]/90 border border-[#1a1a2e] rounded-xl p-4">
            ...
            <div class="mt-3 pt-2 border-t border-[#1a1a2e]">
                <a href="github_login.php" class="flex items-center justify-center gap-2 w-full bg-[#1a1a2e] border border-[#2a2a3e] hover:border-[#00ff88] text-[#e0e0e0] py-2 rounded-lg text-xs font-semibold tracking-wide transition-all hover:bg-[#00ff88]/5">
                ...
                <p class="text-[#555] text-xs text-center mt-2">
