    ...
    <div class="w-full max-w-[380px]">
        ...
        <div class="relative bg-[#0a0a0f]/90 border border-[#1a1a2e] rounded-xl p-6">
            ...
            <?php if (isset($_SESSION['error'])): ?>
                <div class="bg-[#1a0505]/80 border border-[#3a1515] rounded-lg px-4 py-3 mb-5 flex items-center gap-3">
                    <i data-lucide="alert-circle" class="w-4 h-4 text-[#ff4444]"></i>
                    <span class="text-[#ff6666] text-xs"><?php echo htmlspecialchars($_SESSION['error']); unset($_SESSION['error']); ?></span>
                </div>
            <?php endif; ?>
            ...
            <div class="mt-5 pt-4 border-t border-[#1a1a2e]">
                <a href="github_login.php" class="flex items-center justify-center gap-2 w-full bg-[#1a1a2e] border border-[#2a2a3e] hover:border-[#00ff88] text-[#e0e0e0] py-2.5 rounded-lg text-sm font-semibold tracking-wide transition-all hover:bg-[#00ff88]/5">
